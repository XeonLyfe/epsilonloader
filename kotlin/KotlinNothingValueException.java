...
extends RuntimeException {
    ...
    public KotlinNothingValueException(@Nullable String string) {
        super(string);
    }

    public KotlinNothingValueException(@Nullable String string, @Nullable Throwable throwable) {
        super(string, throwable);
    }

    public KotlinNothingValueException(@Nullable Throwable throwable) {
        super(throwable);
    }
}
