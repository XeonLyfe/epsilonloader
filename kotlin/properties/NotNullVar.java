...
implements ReadWriteProperty<Object, T> {
    ...
    @Override
    @NotNull
    public T getValue(@Nullable Object object, @NotNull KProperty<?> kProperty) {
        Intrinsics.checkNotNullParameter(kProperty, "property");
        T t2 = this.value;
        if (t2 == null) {
            throw (Throwable)new IllegalStateException("Property " + kProperty.getName() + " should be initialized before get.");
        }
        return t2;
    }

    @Override
    public void setValue(@Nullable Object object, @NotNull KProperty<?> kProperty, @NotNull T t2) {
        Intrinsics.checkNotNullParameter(kProperty, "property");
