...
public final class Delegates {
    ...
    @NotNull
    public final <T> ReadWriteProperty<Object, T> observable(T t2, @NotNull Function3<? super KProperty<?>, ? super T, ? super T, Unit> function3) {
        int n2 = 0;
        Intrinsics.checkNotNullParameter(function3, "onChange");
        return new ObservableProperty<T>(function3, t2, t2){
            final /* synthetic */ Function3 $onChange;
            final /* synthetic */ Object $initialValue;

            protected void afterChange(@NotNull KProperty<?> kProperty, T t2, T t3) {
                Intrinsics.checkNotNullParameter(kProperty, "property");
                this.$onChange.invoke(kProperty, t2, t3);
            }
            {
    ...
    @NotNull
    public final <T> ReadWriteProperty<Object, T> vetoable(T t2, @NotNull Function3<? super KProperty<?>, ? super T, ? super T, Boolean> function3) {
        int n2 = 0;
        Intrinsics.checkNotNullParameter(function3, "onChange");
        return new ObservableProperty<T>(function3, t2, t2){
            final /* synthetic */ Function3 $onChange;
            ...
            protected boolean beforeChange(@NotNull KProperty<?> kProperty, T t2, T t3) {
                Intrinsics.checkNotNullParameter(kProperty, "property");
                return (Boolean)this.$onChange.invoke(kProperty, t2, t3);
            }
            {
                this.$onChange = function3;
                this.$initialValue = object;
