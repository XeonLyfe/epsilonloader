...
extends Enum<LazyThreadSafetyMode> {
    ...
    static {
        LazyThreadSafetyMode[] arrlazyThreadSafetyMode = new LazyThreadSafetyMode[3];
        LazyThreadSafetyMode[] arrlazyThreadSafetyMode2 = arrlazyThreadSafetyMode;
        arrlazyThreadSafetyMode[0] = SYNCHRONIZED = new LazyThreadSafetyMode();
        arrlazyThreadSafetyMode[1] = PUBLICATION = new LazyThreadSafetyMode();
        arrlazyThreadSafetyMode[2] = NONE = new LazyThreadSafetyMode();
        $VALUES = arrlazyThreadSafetyMode;
    }
