...
implements MatchResult {
        ...
        if (this.groupValues_ == null) {
            this.groupValues_ = new AbstractList<String>(this){
                ...
                public String get(int n2) {
                    String string = MatcherMatchResult.access$getMatchResult$p(this.this$0).group(n2);
                    if (string == null) {
                        string = "";
                    }
                    return string;
    ...
    public MatchResult next() {
        ...
        int n2 = this.getMatchResult().end() + (this.getMatchResult().end() == this.getMatchResult().start() ? 1 : 0);
        if (n2 <= this.input.length()) {
            Matcher matcher = this.matcher.pattern().matcher(this.input);
            Intrinsics.checkNotNullExpressionValue(matcher, "matcher.pattern().matcher(input)");
            matchResult = RegexKt.access$findNext(matcher, n2, this.input);
        } else {
            matchResult = null;
        }
        return matchResult;
        ...
        this.groups = new MatchNamedGroupCollection(this){
            ...
            public Iterator<MatchGroup> iterator() {
                return SequencesKt.map(CollectionsKt.asSequence(CollectionsKt.getIndices(this)), (Function1)new Function1<Integer, MatchGroup>(this){
                    ...
                    @Nullable
                    public final MatchGroup invoke(int n2) {
            ...
            @Nullable
            public MatchGroup get(int n2) {
                MatchGroup matchGroup;
                IntRange intRange = RegexKt.access$range(MatcherMatchResult.access$getMatchResult$p(this.this$0), n2);
            ...
            public MatchGroup get(@NotNull String string) {
                ...
                return PlatformImplementationsKt.IMPLEMENTATIONS.getMatchResultNamedGroup(MatcherMatchResult.access$getMatchResult$p(this.this$0), string);
            }
            {
                this.this$0 = matcherMatchResult;
            }
