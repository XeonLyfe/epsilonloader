...
extends Enum<CharDirectionality> {
    ...
    static {
        CharDirectionality[] arrcharDirectionality = new CharDirectionality[20];
        CharDirectionality[] arrcharDirectionality2 = arrcharDirectionality;
        arrcharDirectionality[0] = UNDEFINED = new CharDirectionality(-1);
        arrcharDirectionality[1] = LEFT_TO_RIGHT = new CharDirectionality(0);
        arrcharDirectionality[2] = RIGHT_TO_LEFT = new CharDirectionality(1);
        arrcharDirectionality[3] = RIGHT_TO_LEFT_ARABIC = new CharDirectionality(2);
        arrcharDirectionality[4] = EUROPEAN_NUMBER = new CharDirectionality(3);
        arrcharDirectionality[5] = EUROPEAN_NUMBER_SEPARATOR = new CharDirectionality(4);
        arrcharDirectionality[6] = EUROPEAN_NUMBER_TERMINATOR = new CharDirectionality(5);
        arrcharDirectionality[7] = ARABIC_NUMBER = new CharDirectionality(6);
        arrcharDirectionality[8] = COMMON_NUMBER_SEPARATOR = new CharDirectionality(7);
        arrcharDirectionality[9] = NONSPACING_MARK = new CharDirectionality(8);
        arrcharDirectionality[10] = BOUNDARY_NEUTRAL = new CharDirectionality(9);
        arrcharDirectionality[11] = PARAGRAPH_SEPARATOR = new CharDirectionality(10);
        arrcharDirectionality[12] = SEGMENT_SEPARATOR = new CharDirectionality(11);
        arrcharDirectionality[13] = WHITESPACE = new CharDirectionality(12);
        arrcharDirectionality[14] = OTHER_NEUTRALS = new CharDirectionality(13);
        arrcharDirectionality[15] = LEFT_TO_RIGHT_EMBEDDING = new CharDirectionality(14);
        arrcharDirectionality[16] = LEFT_TO_RIGHT_OVERRIDE = new CharDirectionality(15);
        arrcharDirectionality[17] = RIGHT_TO_LEFT_EMBEDDING = new CharDirectionality(16);
        arrcharDirectionality[18] = RIGHT_TO_LEFT_OVERRIDE = new CharDirectionality(17);
        arrcharDirectionality[19] = POP_DIRECTIONAL_FORMAT = new CharDirectionality(18);
        $VALUES = arrcharDirectionality;
    ...
    private CharDirectionality(int n3) {
        this.value = n3;
    }
    ...
    public static final class Companion {
        ...
        @NotNull
        public final CharDirectionality valueOf(int n2) {
            CharDirectionality charDirectionality = this.getDirectionalityMap().get(n2);
            if (charDirectionality == null) {
                throw (Throwable)new IllegalArgumentException("Directionality #" + n2 + " is not defined.");
            }
