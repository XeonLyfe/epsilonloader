...
public final class MatchGroup {
    ...
    public static /* synthetic */ MatchGroup copy$default(MatchGroup matchGroup, String string, IntRange intRange, int n2, Object object) {
        if ((n2 & 1) != 0) {
    ...
    public boolean equals(@Nullable Object object) {
        block3: {
            block2: {
                ...
                if (!Intrinsics.areEqual(this.value, matchGroup.value) || !Intrinsics.areEqual(this.range, matchGroup.range)) break block3;
            }
            return true;
        }
        return false;
