...
extends RuntimeException {
    ...
    public NoWhenBranchMatchedException(@Nullable String string) {
        super(string);
    }

    public NoWhenBranchMatchedException(@Nullable String string, @Nullable Throwable throwable) {
        super(string, throwable);
    }

    public NoWhenBranchMatchedException(@Nullable Throwable throwable) {
        super(throwable);
    }
}
