...
implements Serializable {
    ...
    private static final T getOrNull-impl(Object object) {
        int n2 = 0;
        return Result.isFailure-impl(object) ? null : object;
    }

    @Nullable
    public static final Throwable exceptionOrNull-impl(Object object) {
        Object object2 = object;
        return object2 instanceof Failure ? ((Failure)object).exception : null;
    }

    @NotNull
    public static String toString-impl(Object object) {
        Object object2 = object;
        return object2 instanceof Failure ? object.toString() : "Success(" + object + ')';
    }

    @PublishedApi
    @NotNull
    public static Object constructor-impl(@Nullable Object object) {
        return object;
    }
    ...
    implements Serializable {
        ...
        public boolean equals(@Nullable Object object) {
            return object instanceof Failure && Intrinsics.areEqual(this.exception, ((Failure)object).exception);
        }
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T t2) {
            int n2 = 0;
            return Result.constructor-impl(t2);
        }
