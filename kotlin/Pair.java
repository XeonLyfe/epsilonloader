...
implements Serializable {
    ...
    public static /* synthetic */ Pair copy$default(Pair pair, Object object, Object object2, int n2, Object object3) {
        if ((n2 & 1) != 0) {
            object = pair.first;
        }
        if ((n2 & 2) != 0) {
    ...
    public int hashCode() {
        A a2 = this.first;
        B b2 = this.second;
        return (a2 != null ? a2.hashCode() : 0) * 31 + (b2 != null ? b2.hashCode() : 0);
    }
    ...
    public boolean equals(@Nullable Object object) {
        block3: {
            block2: {
                ...
                if (!(object instanceof Pair)) break block3;
                Pair pair = (Pair)object;
                if (!Intrinsics.areEqual(this.first, pair.first) || !Intrinsics.areEqual(this.second, pair.second)) break block3;
            }
            return true;
        }
        return false;
