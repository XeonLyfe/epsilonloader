...
extends Enum<RequireKotlinVersionKind> {
    ...
    static {
        RequireKotlinVersionKind[] arrrequireKotlinVersionKind = new RequireKotlinVersionKind[3];
        RequireKotlinVersionKind[] arrrequireKotlinVersionKind2 = arrrequireKotlinVersionKind;
        arrrequireKotlinVersionKind[0] = LANGUAGE_VERSION = new RequireKotlinVersionKind();
        arrrequireKotlinVersionKind[1] = COMPILER_VERSION = new RequireKotlinVersionKind();
        arrrequireKotlinVersionKind[2] = API_VERSION = new RequireKotlinVersionKind();
        $VALUES = arrrequireKotlinVersionKind;
    }
