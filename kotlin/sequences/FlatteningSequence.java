        ...
        return new Iterator<E>(this){
            ...
            private final boolean ensureItemIterator() {
                ...
                while (this.itemIterator == null) {
                    ...
                    Iterator iterator3 = (Iterator)FlatteningSequence.access$getIterator$p(this.this$0).invoke(FlatteningSequence.access$getTransformer$p(this.this$0).invoke(t2));
