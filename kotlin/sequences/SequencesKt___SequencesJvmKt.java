...
extends SequencesKt__SequencesKt {
    @NotNull
    public static final <R> Sequence<R> filterIsInstance(@NotNull Sequence<?> sequence, @NotNull Class<R> class_) {
        Intrinsics.checkNotNullParameter(sequence, "$this$filterIsInstance");
        Intrinsics.checkNotNullParameter(class_, "klass");
        Sequence<?> sequence2 = SequencesKt.filter(sequence, (Function1)new Function1<Object, Boolean>(class_){
    ...
    @NotNull
    public static final <C extends Collection<? super R>, R> C filterIsInstanceTo(@NotNull Sequence<?> sequence, @NotNull C c2, @NotNull Class<R> class_) {
