...
CoroutineStackFrame {
     ...
     */
    @Override
    public void resumeWith(@NotNull Object var1_1) {
        do lbl-1000:
        // 3 sources

        {
            block1: {
                var2_2 = this.result;
                if (var2_2 != CoroutineSingletons.UNDECIDED) break block1;
                if (!SafeContinuation.RESULT.compareAndSet(this, (Object)CoroutineSingletons.UNDECIDED, var1_1)) ** GOTO lbl-1000
                return;
            }
            if (var2_2 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) throw (Throwable)new IllegalStateException("Already resumed");
        } while (!SafeContinuation.RESULT.compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), (Object)CoroutineSingletons.RESUMED));
        this.delegate.resumeWith(var1_1);
    }
    ...
    public final Object getOrThrow() {
        ...
        if (object2 == CoroutineSingletons.UNDECIDED) {
    ...
    public SafeContinuation(@NotNull Continuation<? super T> continuation, @Nullable Object object) {
    ...
    public SafeContinuation(@NotNull Continuation<? super T> continuation) {
        Intrinsics.checkNotNullParameter(continuation, "delegate");
        this(continuation, (Object)CoroutineSingletons.UNDECIDED);
    }
