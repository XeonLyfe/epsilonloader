...
extends Enum<CoroutineSingletons> {
    ...
    static {
        CoroutineSingletons[] arrcoroutineSingletons = new CoroutineSingletons[3];
        CoroutineSingletons[] arrcoroutineSingletons2 = arrcoroutineSingletons;
        arrcoroutineSingletons[0] = COROUTINE_SUSPENDED = new CoroutineSingletons();
        arrcoroutineSingletons[1] = UNDECIDED = new CoroutineSingletons();
        arrcoroutineSingletons[2] = RESUMED = new CoroutineSingletons();
        $VALUES = arrcoroutineSingletons;
    }
