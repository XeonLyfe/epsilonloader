...
extends Enum<OnErrorAction> {
    ...
    static {
        OnErrorAction[] arronErrorAction = new OnErrorAction[2];
        OnErrorAction[] arronErrorAction2 = arronErrorAction;
        arronErrorAction[0] = SKIP = new OnErrorAction();
        arronErrorAction[1] = TERMINATE = new OnErrorAction();
        $VALUES = arronErrorAction;
    }
