...
extends FileSystemException {
    public AccessDeniedException(@NotNull File file, @Nullable File file2, @Nullable String string) {
        Intrinsics.checkNotNullParameter(file, "file");
        super(file, file2, string);
    }

    public /* synthetic */ AccessDeniedException(File file, File file2, String string, int n2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((n2 & 2) != 0) {
            file2 = null;
        }
        if ((n2 & 4) != 0) {
