...
extends Enum<FileWalkDirection> {
    ...
    static {
        FileWalkDirection[] arrfileWalkDirection = new FileWalkDirection[2];
        FileWalkDirection[] arrfileWalkDirection2 = arrfileWalkDirection;
        arrfileWalkDirection[0] = TOP_DOWN = new FileWalkDirection();
        arrfileWalkDirection[1] = BOTTOM_UP = new FileWalkDirection();
        $VALUES = arrfileWalkDirection;
    }
