...
public final class FilePathComponents {
    ...
    @NotNull
    public final File subPath(int n2, int n3) {
        if (n2 < 0 || n2 > n3 || n3 > this.getSize()) {
            throw (Throwable)new IllegalArgumentException();
        }
        Iterable iterable = this.segments.subList(n2, n3);
    ...
    public static /* synthetic */ FilePathComponents copy$default(FilePathComponents filePathComponents, File file, List list, int n2, Object object) {
        if ((n2 & 1) != 0) {
