...
TypeImpl {
    ...
    public boolean equals(@Nullable Object object) {
        ...
        if (!Intrinsics.areEqual(this.rawType, ((ParameterizedType)object).getRawType())) return false;
        if (!Intrinsics.areEqual(this.ownerType, ((ParameterizedType)object).getOwnerType())) return false;
        Object[] arrobject = this.getActualTypeArguments();
        Object[] arrobject2 = ((ParameterizedType)object).getActualTypeArguments();
        boolean bl = false;
    ...
    public int hashCode() {
        ...
        boolean bl = false;
        int n2 = arrobject != null ? arrobject.hashCode() : 0;
        arrobject = this.getActualTypeArguments();
        bl = false;
        return this.rawType.hashCode() ^ n2 ^ Arrays.hashCode(arrobject);
    }
    ...
    public ParameterizedTypeImpl(@NotNull Class<?> class_, @Nullable Type type, @NotNull List<? extends Type> list) {
        Intrinsics.checkNotNullParameter(class_, "rawType");
        ...
        Type[] arrtype = collection2.toArray(new Type[0]);
        if (arrtype == null) {
