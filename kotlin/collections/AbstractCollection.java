...
KMappedMarker {
    ...
    public boolean contains(Object object) {
        ...
        block3: {
            ...
            boolean bl2 = false;
            if (abstractCollection instanceof Collection && ((Collection)abstractCollection).isEmpty()) {
                bl = false;
            } else {
                ...
                while (iterator2.hasNext()) {
                    ...
                    boolean bl3 = false;
                    if (!Intrinsics.areEqual(t3, object)) continue;
                    bl = true;
                    break block3;
                }
                bl = false;
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(this, ", ", "[", "]", 0, null, new Function1<E, CharSequence>(this){
            ...
            public final CharSequence invoke(E e2) {
                return e2 == this.this$0 ? (CharSequence)"(this Collection)" : (CharSequence)String.valueOf(e2);
            }
            {
