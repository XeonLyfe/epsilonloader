...
KMappedMarker {
    ...
    public int indexOf(Object object) {
        ...
        block2: {
            ...
            boolean bl = false;
            int n3 = 0;
            Iterator iterator2 = abstractList.iterator();
            while (iterator2.hasNext()) {
                Object e2;
                Object e3 = e2 = iterator2.next();
                boolean bl2 = false;
                if (Intrinsics.areEqual(e3, object)) {
                    n2 = n3;
                    break block2;
                }
                ++n3;
    ...
    public int lastIndexOf(Object object) {
        ...
        block1: {
            ...
            while (listIterator.hasPrevious()) {
                ...
                boolean bl2 = false;
                if (!Intrinsics.areEqual(e2, object)) continue;
    ...
    public ListIterator<E> listIterator(int n2) {
        return new ListIteratorImpl(n2);
    }
    ...
    implements RandomAccess {
        ...
        @Override
        public E get(int n2) {
            Companion.checkElementIndex$kotlin_stdlib(n2, this._size);
            return this.list.get(this.fromIndex + n2);
        }
        ...
        public SubList(@NotNull AbstractList<? extends E> abstractList, int n2, int n3) {
            Intrinsics.checkNotNullParameter(abstractList, "list");
            this.list = abstractList;
            this.fromIndex = n2;
            Companion.checkRangeIndexes$kotlin_stdlib(this.fromIndex, n3, this.list.size());
            this._size = n3 - this.fromIndex;
        }
    }
    ...
    KMappedMarker {
        ...
        protected final void setIndex(int n2) {
            this.index = n2;
        }
        ...
        public E next() {
            ...
            int n2 = this.index;
            this.index = n2 + 1;
            return AbstractList.this.get(n2);
        }
    ...
    KMappedMarker {
        ...
        public ListIteratorImpl(int n2) {
            Companion.checkPositionIndex$kotlin_stdlib(n2, AbstractList.this.size());
            this.setIndex(n2);
        }
    ...
    public static final class Companion {
        public final void checkElementIndex$kotlin_stdlib(int n2, int n3) {
            if (n2 < 0 || n2 >= n3) {
                throw (Throwable)new IndexOutOfBoundsException("index: " + n2 + ", size: " + n3);
            }
        }

        public final void checkPositionIndex$kotlin_stdlib(int n2, int n3) {
            if (n2 < 0 || n2 > n3) {
                throw (Throwable)new IndexOutOfBoundsException("index: " + n2 + ", size: " + n3);
            }
        }

        public final void checkRangeIndexes$kotlin_stdlib(int n2, int n3, int n4) {
            if (n2 < 0 || n3 > n4) {
                throw (Throwable)new IndexOutOfBoundsException("fromIndex: " + n2 + ", toIndex: " + n3 + ", size: " + n4);
            }
            if (n2 > n3) {
                throw (Throwable)new IllegalArgumentException("fromIndex: " + n2 + " > toIndex: " + n3);
            }
        }

        public final void checkBoundsIndexes$kotlin_stdlib(int n2, int n3, int n4) {
            if (n2 < 0 || n3 > n4) {
                throw (Throwable)new IndexOutOfBoundsException("startIndex: " + n2 + ", endIndex: " + n3 + ", size: " + n4);
            }
            if (n2 > n3) {
                throw (Throwable)new IllegalArgumentException("startIndex: " + n2 + " > endIndex: " + n3);
            }
        }
        ...
        public final int orderedHashCode$kotlin_stdlib(@NotNull Collection<?> collection) {
            ...
            while (iterator2.hasNext()) {
                ...
                n2 = 31 * n2 + (obj2 != null ? obj2.hashCode() : 0);
            }
            return n2;
        }
        ...
        public final boolean orderedEquals$kotlin_stdlib(@NotNull Collection<?> collection, @NotNull Collection<?> collection2) {
            ...
            for (Object obj : collection) {
                Object obj2;
                if (!(Intrinsics.areEqual(obj, obj2 = iterator2.next()) ^ true)) continue;
                return false;
            }
            return true;
        }
