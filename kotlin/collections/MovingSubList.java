...
implements RandomAccess {
    ...
    public final void move(int n2, int n3) {
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(n2, n3, this.list.size());
        this.fromIndex = n2;
        this._size = n3 - n2;
    }
    ...
    @Override
    public E get(int n2) {
        AbstractList.Companion.checkElementIndex$kotlin_stdlib(n2, this._size);
