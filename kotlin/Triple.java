...
implements Serializable {
    ...
    public final Triple<A, B, C> copy(A a2, B b2, C c2) {
        return new Triple<A, B, C>(a2, b2, c2);
    }

    public static /* synthetic */ Triple copy$default(Triple triple, Object object, Object object2, Object object3, int n2, Object object4) {
        if ((n2 & 1) != 0) {
            object = triple.first;
        }
        if ((n2 & 2) != 0) {
    ...
    public int hashCode() {
        ...
        B b2 = this.second;
        C c2 = this.third;
        return ((a2 != null ? a2.hashCode() : 0) * 31 + (b2 != null ? b2.hashCode() : 0)) * 31 + (c2 != null ? c2.hashCode() : 0);
    }
