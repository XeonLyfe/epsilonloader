...
extends Error {
    ...
    public KotlinReflectionNotSupportedError(@Nullable String string) {
        super(string);
    }

    public KotlinReflectionNotSupportedError(@Nullable String string, @Nullable Throwable throwable) {
        super(string, throwable);
    }

    public KotlinReflectionNotSupportedError(@Nullable Throwable throwable) {
        super(throwable);
    }
}
