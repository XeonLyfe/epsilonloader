...
extends PrimitiveSpreadBuilder<short[]> {
    ...
    @Override
    protected int getSize(@NotNull short[] arrs) {
        Intrinsics.checkNotNullParameter(arrs, "$this$getSize");
        return arrs.length;
    }

    public final void add(short s2) {
        ShortSpreadBuilder shortSpreadBuilder = this;
        int n2 = shortSpreadBuilder.getPosition();
        shortSpreadBuilder.setPosition(n2 + 1);
        this.values[n2] = s2;
    }
    ...
    public ShortSpreadBuilder(int n2) {
        super(n2);
