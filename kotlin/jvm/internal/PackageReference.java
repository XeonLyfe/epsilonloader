...
implements ClassBasedDeclarationContainer {
    ...
    public boolean equals(@Nullable Object object) {
        return object instanceof PackageReference && Intrinsics.areEqual(this.getJClass(), ((PackageReference)object).getJClass());
    }
    ...
    public PackageReference(@NotNull Class<?> class_, @NotNull String string) {
        Intrinsics.checkNotNullParameter(class_, "jClass");
        Intrinsics.checkNotNullParameter(string, "moduleName");
        this.jClass = class_;
