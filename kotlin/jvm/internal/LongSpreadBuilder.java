...
extends PrimitiveSpreadBuilder<long[]> {
    ...
    @Override
    protected int getSize(@NotNull long[] arrl) {
        Intrinsics.checkNotNullParameter(arrl, "$this$getSize");
        return arrl.length;
    }

    public final void add(long l2) {
        LongSpreadBuilder longSpreadBuilder = this;
        int n2 = longSpreadBuilder.getPosition();
        longSpreadBuilder.setPosition(n2 + 1);
        this.values[n2] = l2;
    }
    ...
    public LongSpreadBuilder(int n2) {
        super(n2);
