...
extends PrimitiveSpreadBuilder<boolean[]> {
    ...
    @Override
    protected int getSize(@NotNull boolean[] arrbl) {
        Intrinsics.checkNotNullParameter(arrbl, "$this$getSize");
        return arrbl.length;
    }

    public final void add(boolean bl) {
        BooleanSpreadBuilder booleanSpreadBuilder = this;
        int n2 = booleanSpreadBuilder.getPosition();
        booleanSpreadBuilder.setPosition(n2 + 1);
        this.values[n2] = bl;
    }
    ...
    public BooleanSpreadBuilder(int n2) {
        super(n2);
        this.values = new boolean[n2];
    }
}
