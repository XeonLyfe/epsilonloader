...
public class TypeIntrinsics {
    private static <T extends Throwable> T sanitizeStackTrace(T t2) {
        return Intrinsics.sanitizeStackTrace(t2, TypeIntrinsics.class.getName());
    }
    ...
    public static boolean isFunctionOfArity(Object object, int n2) {
        return object instanceof Function && TypeIntrinsics.getFunctionArity(object) == n2;
    }

    public static Object beforeCheckcastToFunctionOfArity(Object object, int n2) {
        if (object != null && !TypeIntrinsics.isFunctionOfArity(object, n2)) {
            TypeIntrinsics.throwCce(object, "kotlin.jvm.functions.Function" + n2);
        }
        return object;
    }

    public static Object beforeCheckcastToFunctionOfArity(Object object, int n2, String string) {
        if (object != null && !TypeIntrinsics.isFunctionOfArity(object, n2)) {
            TypeIntrinsics.throwCce(string);
        }
        return object;
