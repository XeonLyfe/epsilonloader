...
implements ClosedRange<UInt> {
    ...
    public boolean contains-WZ4Q5Ns(int n2) {
        int n3 = this.getFirst-pVg5ArA();
        int n4 = 0;
        if (UnsignedKt.uintCompare(n3, n2) > 0) return false;
        n3 = n2;
        n4 = this.getLast-pVg5ArA();
        boolean bl = false;
        if (UnsignedKt.uintCompare(n3, n4) > 0) return false;
        return true;
    }
    ...
    public boolean isEmpty() {
        ...
        int n3 = this.getLast-pVg5ArA();
        boolean bl = false;
        return UnsignedKt.uintCompare(n2, n3) > 0;
    }
    ...
    private UIntRange(int n2, int n3) {
        super(n2, n3, 1, null);
    }

    static {
        Companion = new Companion(null);
        EMPTY = new UIntRange(-1, 0);
    }

    public /* synthetic */ UIntRange(int n2, int n3, DefaultConstructorMarker defaultConstructorMarker) {
        this(n2, n3);
    }
