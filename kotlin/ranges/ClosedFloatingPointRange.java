...
extends ClosedRange<T> {
    ...
    public static final class DefaultImpls {
        public static <T extends Comparable<? super T>> boolean contains(@NotNull ClosedFloatingPointRange<T> closedFloatingPointRange, @NotNull T t2) {
            Intrinsics.checkNotNullParameter(t2, "value");
            return closedFloatingPointRange.lessThanOrEquals((T)closedFloatingPointRange.getStart(), t2) && closedFloatingPointRange.lessThanOrEquals(t2, (T)closedFloatingPointRange.getEndInclusive());
        }
