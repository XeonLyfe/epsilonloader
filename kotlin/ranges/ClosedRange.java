...
public interface ClosedRange<T extends Comparable<? super T>> {
    ...
    public static final class DefaultImpls {
        public static <T extends Comparable<? super T>> boolean contains(@NotNull ClosedRange<T> closedRange, @NotNull T object) {
            Intrinsics.checkNotNullParameter(object, "value");
            return object.compareTo(closedRange.getStart()) >= 0 && object.compareTo(closedRange.getEndInclusive()) <= 0;
        }
