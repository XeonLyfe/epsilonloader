...
KMappedMarker {
    ...
    public boolean equals(@Nullable Object object) {
        return object instanceof IntProgression && (this.isEmpty() && ((IntProgression)object).isEmpty() || this.first == ((IntProgression)object).first && this.last == ((IntProgression)object).last && this.step == ((IntProgression)object).step);
    }
    ...
    public IntProgression(int n2, int n3, int n4) {
        if (n4 == 0) {
        ...
        this.first = n2;
        this.last = ProgressionUtilKt.getProgressionLastElement(n2, n3, n4);
        this.step = n4;
    }
    ...
    public static final class Companion {
        @NotNull
        public final IntProgression fromClosedRange(int n2, int n3, int n4) {
            return new IntProgression(n2, n3, n4);
        }
