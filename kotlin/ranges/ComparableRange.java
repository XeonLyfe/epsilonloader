...
implements ClosedRange<T> {
    ...
    public boolean equals(@Nullable Object object) {
        return object instanceof ComparableRange && (this.isEmpty() && ((ComparableRange)object).isEmpty() || Intrinsics.areEqual(this.getStart(), ((ComparableRange)object).getStart()) && Intrinsics.areEqual(this.getEndInclusive(), ((ComparableRange)object).getEndInclusive()));
    }
    ...
    public ComparableRange(@NotNull T t2, @NotNull T t3) {
        Intrinsics.checkNotNullParameter(t2, "start");
        Intrinsics.checkNotNullParameter(t3, "endInclusive");
        this.start = t2;
        this.endInclusive = t3;
    }
