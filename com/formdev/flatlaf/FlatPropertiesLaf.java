...
extends FlatLaf {
    ...
    public FlatPropertiesLaf(String string, File file) throws IOException {
        this(string, new FileInputStream(file));
    }

    public FlatPropertiesLaf(String string, InputStream inputStream) throws IOException {
    ...
    public FlatPropertiesLaf(String string, Properties properties) {
        ...
        this.dark = "dark".equalsIgnoreCase(this.baseTheme) || "darcula".equalsIgnoreCase(this.baseTheme) ? (int)-76911849L ^ 0xFB6A6B16 : (int)((long)2072944314 ^ (long)2072944314);
    }
